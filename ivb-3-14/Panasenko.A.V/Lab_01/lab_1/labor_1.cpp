...
/* Лабораторная работа №1
	...
	* ИВБ-3-14
	* Панасенко Андрей
Определить в каком массиве меньше сумма элементов, поподающих в заданный диапазон. Если в двух или трех массивах  суммы совпадают, вывести соответствующее сообщение.*/
