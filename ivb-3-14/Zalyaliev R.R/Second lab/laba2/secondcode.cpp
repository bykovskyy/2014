//**Даны двематрицы разного размера.Для той из матриц,в которой есть элементы, равные 0,найтисреднееарифметическоеположительныхэлементоввкаждой строке*/ 
...
static bool
__findNulElement(double **pMatrix, int rows, int cols);
static void
...
main(int argc, char **argv)
{
	...
	/** Find max element */
	bool nul1 = __findNulElement(matrix1, mRows1, mCols1);
	bool nul2 = __findNulElement(matrix2, mRows2, mCols2);
	if (nul1) {
